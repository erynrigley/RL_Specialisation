...
for n in range(100):
    ...
    for _ in range(100):
        ...
        if np.random.random() > 0.1:
            ...
            print("mine", agent.values)
            print("yours", prev_agent_vals)
            assert(np.allclose(prev_agent_vals, agent.values))
            break
...
policy[36] = [1, 0, 0, 0] #up
policy[24] = [1, 0, 0, 0] #up
policy[12] = [1, 0, 0, 0] #up
for i in range(0, 11): 
    policy[i] = [0, 0, 0, 1] #along
policy[11] = [0, 0, 1, 0] #down
policy[23] = [0, 0, 1, 0] #down
